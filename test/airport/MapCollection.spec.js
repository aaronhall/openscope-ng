...
test('throws if called with missing parameters', () => {
    const expectedMessage =
        /Invalid parameter\(s\) passed to MapCollection constructor\. Expected mapJson, defaultMaps, airportPositionModel and magneticNorth to be defined, but received .*/;
    ...
    expect(
        () =>
            new MapCollection(null, DEFAULT_MAPS_MOCK, airportPositionFixtureKCYHZ, magneticNorth),
        {
            instanceOf: TypeError,
            message: expectedMessage,
        }
    ...
    expect(
        () => new MapCollection(MAP_MOCK, DEFAULT_MAPS_MOCK, airportPositionFixtureKCYHZ, null),
        {
            instanceOf: TypeError,
            message: expectedMessage,
        }
...
test('throws if called with invalid mapJson', () => {
    const expectedMessage =
        /Invalid mapJson passed to MapCollection constructor\. Expected a non-empty array, but received .*/;

    expect(
        () => new MapCollection({}, DEFAULT_MAPS_MOCK, airportPositionFixtureKCYHZ, magneticNorth),
        {
            instanceOf: TypeError,
            message: expectedMessage,
        }
    ...
    expect(
        () => new MapCollection(42, DEFAULT_MAPS_MOCK, airportPositionFixtureKCYHZ, magneticNorth),
        {
            instanceOf: TypeError,
            message: expectedMessage,
        }
    ...
    expect(
        () =>
            new MapCollection(false, DEFAULT_MAPS_MOCK, airportPositionFixtureKCYHZ, magneticNorth),
        {
            instanceOf: TypeError,
            message: expectedMessage,
        }
...
test('throws if called with invalid defaultMaps', () => {
    const expectedMessage =
        /Invalid defaultMaps passed to MapCollection constructor\. Expected a non-empty array, but received .*/;
    ...
    expect(
        () => new MapCollection(MAP_MOCK, 'threeve', airportPositionFixtureKCYHZ, magneticNorth),
        {
            instanceOf: TypeError,
            message: expectedMessage,
        }
...
test('throws if called with invalid airportPositionModel', () => {
    const expectedMessage =
        /Invalid airportPositionModel passed to MapCollection constructor\. Expected instance of StaticPositionModel, but received .*/;
...
test('does not throw when instantiated with a 0 magneticNorth', () => {
    expect(
        () => new MapCollection(MAP_MOCK, DEFAULT_MAPS_MOCK, airportPositionFixtureKCYHZ, 0)
    ).not.toThrow();
});

test('accepts a map array that is used to set the instance properties', () => {
    const model = new MapCollection(
        MAP_MOCK,
        DEFAULT_MAPS_MOCK,
        airportPositionFixtureKCYHZ,
        magneticNorth
