...
export const RADAR_TARGET_ARRIVAL_MOCK = new RadarTargetModel(
    THEME.DEFAULT,
    ARRIVAL_AIRCRAFT_MODEL_MOCK
);
export const RADAR_TARGET_DEPARTURE_MOCK = new RadarTargetModel(
    THEME.DEFAULT,
    DEPARTURE_AIRCRAFT_MODEL_MOCK
);

export const createRadarTargetArrivalMock = () =>
    new RadarTargetModel(THEME.DEFAULT, ARRIVAL_AIRCRAFT_MODEL_MOCK);
export const createRadarTargetDepartureMock = () =>
    new RadarTargetModel(THEME.DEFAULT, DEPARTURE_AIRCRAFT_MODEL_MOCK);
