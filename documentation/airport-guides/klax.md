...
| Area            | Sector         | Callsign  | Available in openScope NG |
|-----------------|----------------|-----------|------------------------|
...
The area available for control in openScope NG is a combination of the Los Angeles area (responsible for arrivals into LAX) and the Del Rey area (responsible for departures out of LAX) in a West configuration (landing and departing 24L/R & 25L/R).
...
- KLAX usually operates an "Over Ocean" configuration at night, where aircraft will depart from runways 24L and 25R and land in the opposite direction on 6L and 7R. This configuration is not simulated in openScope NG.
