...
##### Departures
DCA has various instrument departures which are all available for usage in openScope NG. The only departure which is not assigned automatically is the National Seven (NATNL7) departure as it is used much less frequently than the others.
...
Unfortunately it isn't possible to simulate the RIVER 3 approach for runway 19; runway 01 is preferred for departure and arrival in openScope NG.
