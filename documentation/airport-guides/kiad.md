...
##### Departures
Dulles has 10 Standard Instrument Departures (SIDs) which are all available in openScope NG. The only departure which is not assigned automatically is the Capital One (CPTAL1) departure as it is used much less frequently than the others.
...
The following sectors are part of the Shenandoah Area of the PCT and available in openScope NG.
