...
+--------+--------+  +--------+--------+--------+
```
In openScope NG, KATL is running a west configuration, meaning that runways 26L, 27R and 28 are used for departures, while arrivals use runways 26R, 27L and 28.
