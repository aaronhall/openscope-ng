...
[airportLoadList.json](https://github.com/aaronhall/openscope-ng/blob/develop/assets/airports/airportLoadList.json)
...
- the [airport JSON file](https://github.com/aaronhall/openscope-ng/blob/develop/documentation/airport-format.md)
...
set out in the documentation](https://github.com/aaronhall/openscope-ng/blob/develop/documentation/airport-file-standards.md)
before being added.
