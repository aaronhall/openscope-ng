...
This guide will show you how to generate a terrain file for any airport in openScope NG. This is mainly done using QGIS, a free and open source Geographic Information System. The process can be quite tedious and often frustrating, so if you get stuck somewhere, you can [open an issue](https://github.com/aaronhall/openscope-ng/issues), where we will be happy to help you!
...
If you're having any problems while following this guide, you can [open an issue](https://github.com/aaronhall/openscope-ng/issues), where we will be happy to help you!
