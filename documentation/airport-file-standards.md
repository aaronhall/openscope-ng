...
If you ever need help working on an airport, please [open an issue](https://github.com/aaronhall/openscope-ng/issues). There is always somebody available to help walk you through anything you may need.

If you have not contributed before, read the [contribution guidelines](../CONTRIBUTING.md) and use the openScope NG repository for branches and pull requests.
